<!-- Offcanvas for Mobile Navigation (Dark to maintain readability on small screens) -->
    <div class="offcanvas offcanvas-start bg-dark" tabindex="-1" id="offcanvasNav" aria-labelledby="offcanvasNavLabel">
        ...
        <div class="offcanvas-body">
            <!-- Mobile Nav Links - mirrored from sidebar -->
    ...
    <div class="app-container">
        <!-- --------------------------------- -->
        <!-- Fixed Sidebar (Desktop) - White Theme -->
        <!-- --------------------------------- -->
        <nav class="sidebar d-none d-lg-block">
            <h1 class="sidebar-header">BinTrack</h1>
            
            <div class="mb-5 sidebar-profile-info">
                <p class="fw-bold mb-1">Collector ID: <span class="text-green">#C901</span></p>
                <p class="small text-muted mb-0">Route Manager: John Doe</p>
            </div>
        ...
        <main class="main-content">
            <!-- Top Bar for Mobile Menu and User Info -->
            <div class="d-flex justify-content-between align-items-center mb-4 pt-2">
                <button class="btn btn-outline-primary d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNav" aria-controls="offcanvasNav">
                    <i class="bi bi-list"></i> Menu
                </button>
                <h2 class="h4 mb-0 d-lg-none text-dark-green fw-bold">BinTrack</h2>
                <div class="d-flex align-items-center">
                    <span class="d-none d-sm-block me-3 text-muted">Welcome, John Doe!</span>
